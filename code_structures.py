...
#     break
#
# '''Зчитайте цілі числа, які вводить користувач, по одному числу у рядку. Для кожного введеного числа виконайте перевірку: якщо число менше 10,
# то пропускаємо це число, якщо число більше 100, то припиняємо зчитувати числа. У інших випадках вивести це число в окремому рядку.'''
# while True:
#     try:
...
#     print(user_num)
#
# '''Напишіть простий калькулятор, який зчитує три рядки, які вводить користувач: перше число, друге число і операцію, після чого застосовує операцію
# до введених числах («перше число» «операція» «друге число») і виводить результат на екран. Підтримувані операції: +, -, /, *, mod, pow, div, де mod -
# це взяття залишку від ділення, pow - піднесення до степеня, div - цілочисельне ділення. У випадку ділення на 0, необхідно використати обробник винятку,
# який має вивести повідомлення Division by zero!.'''
#
# def calculator():
#     while True:
#         try:
...
#             op = input("Введіть операцію (+, -, *, /, mod, pow, div): ").strip()
#
#             if op == "+":
#                 print(first + second)
#             elif op == "-":
